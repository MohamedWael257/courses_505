...
const CancelOrderForm: React.FC<CancelOrderFormProps> = ({
  ...
  const formSchema = Yup.object({
    reason: Yup.string().required(t("message is a required field")),
  ...
  return (
    <div className="flex flex-col gap-0 pt-6 w-full p-4">
      <ScrollArea className="grow " dir={locale === "en" ? "ltr" : "rtl"}>
        <div className={`h-[555px] flex flex-col pe-2`}>
          <div className="flex flex-col gap-3 my-4">
            ...
            <div className="bg-greynormal px-4 py-3 rounded-xl  text-xs flex items-center gap-1.5">
              ...
              يرجي العلم أنه: في حالة قبول الأدمن للطلب يتم ارجاع الأموال عن
              طريق بوابة الدفع
              <LocalePath
                href="/return-policy"
